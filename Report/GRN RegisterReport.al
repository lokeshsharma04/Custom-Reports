report 50146 "Bill Wise GRN Register"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Bill Wise GRN Register';
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/GRNReport Register.rdl';
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Posting Date", "No.", "Location Code";
            ...
            dataitem("Purch. Rcpt. Line"; "Purch. Rcpt. Line")
            {
                ...
                { }
                column(Unit_of_Measure; UOM.Code)
                {
                ...
                // {
                // }
                column(DISCOUNT_AMNT; "Job Line Discount Amount")
                {
