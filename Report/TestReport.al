...
report 50199 "GSTR-1 File Format11"
{
    Caption = 'GSTR-1 File Format Custom';
    ProcessingOnly = true;
    UseRequestPage = true;
    ...
    begin
        ...
        Clear(GSTR1IntraCess);
        clear(GSTR1InterCess);
...
Clear(TotalCessAmount);
    ...
    begin
        ...
        GSTR1NonGSTExempCrMemo.SetRange(Location_GST_Reg__No_, LocationGSTIN);
        GSTR1NonGSTExempCrMemo.SetRange(Posting_Date, StartDate, EndDate);
        GSTR1NonGSTExempCrMemo.SetFilter(GST_Customer_Type, '%1|%2', "GST Customer Type"::Unregistered, "GST Customer Type"::Export);
        GSTR1NonGSTExempCrMemo.SetFilter(GST_Jurisdiction_Type, '%1', "GST Jurisdiction Type"::Interstate);
        GSTR1NonGSTExempCrMemo.Open();
        while GSTR1NonGSTExempCrMemo.Read() do
