report 50105 "Standard Sales - Credit"
{
    RDLCLayout = 'Layout/StandardSalesCreditMemo.rdl';
...
#pragma warning disable 
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            column(ComInfPicture; ComInf.Picture)
            {
            ...
            dataitem(Line; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    Clear(CGSTPer_);
                    DetailedGST.Reset();
                    DetailedGST.SetRange("Document No.", Line."Document No.");
                    DetailedGST.SetRange("Document Line No.", Line."Line No.");
