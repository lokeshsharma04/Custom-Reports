Report 76954 "GST B2CL"
{
        ...
        dataitem("Detailed GST Ledger Entry"; "Detailed GST Ledger Entry")
        {
            ...
            begin
                ...
                if not DataExport_lBln then
                    Error('Case not found for Data Export');//PT
            end;
    ...
    var
        ...
        GSTB2CL_lRec: Record "GST B2CL_Saffron";
    ...
    var
        ...
        GSTB2CL_gRec: Record "GST B2CL_Saffron";
    ...
    local procedure MakeExcelDataBody_lFnc(GSTB2CL_iRec: Record "GST B2CL_Saffron")
    var
