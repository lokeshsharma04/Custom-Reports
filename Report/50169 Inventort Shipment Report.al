Report 50169 "Inventory Shipment report"
{
    DefaultLayout = RDLC;
    UsageCategory = Administration;
    ApplicationArea = all;

    RDLCLayout = 'Layout/InventoryShipmentreport.rdl';
    PreviewMode = PrintLayout;

    dataset
    {
        dataitem("Invt. Document Header"; "Invt. Shipment Header")
        {
            ...
            dataitem("Invt. Document Line"; "Invt. Shipment Line")
            {
